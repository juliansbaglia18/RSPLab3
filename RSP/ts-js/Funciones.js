...
(function (SP) {
    ...
    window.addEventListener("load", function () {
        ...
        var btnLimpiarDatos = document.getElementById("btnLimpiarDatos");
    ...
    SP.FiltroApellido = FiltroApellido;
    function FiltroEdad() {
    ...
    function AgregarCliente() {
        ...
        if (flag == true) {
            ...
            var cliente = new SP.Cliente(id, nombre, apellido, edad, sexoAux);
            listaPersonas.push(cliente);
            LimpiarContenedor();
            CargarTabla(listaPersonas);
        }
    }
    SP.AgregarCliente = AgregarCliente;
    function obtenerMasculinos() {
        return listaPersonas.filter(function (cliente) {
            return cliente.sexo == 1;
        });
    }
    SP.obtenerMasculinos = obtenerMasculinos;
    function obtenerFemeninos() {
        return listaPersonas.filter(function (cliente) {
            return cliente.sexo == 2;
        });
    }
    SP.obtenerFemeninos = obtenerFemeninos;
    function Filtrar() {
    ...
    SP.LlenarContenedor = LlenarContenedor;
    ...
    SP.LimpiarContenedor = LimpiarContenedor;
